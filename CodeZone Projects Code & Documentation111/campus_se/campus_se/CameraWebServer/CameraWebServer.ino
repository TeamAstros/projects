...
#define API_KEY "AIzaSyCm1WpvezWKtH_HH5BauzwmLhVhfszyKew"

// Insert RTDB URL
#define DATABASE_URL "https://campus-2e40e-default-rtdb.asia-southeast1.firebasedatabase.app/"
...
// ===========================
const char *ssid = "Atharva More";
const char *password = "LLawliet";
...
if(pir_s==1){
  ...
  if (Firebase.RTDB.setInt(&fbdo, "test/motion", pir_s)) {
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
      old_pir= pir_s ;
  ...
  if (Firebase.RTDB.setInt(&fbdo, "test/flame", flame_s)) {
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
      old_flame= flame_s ;
